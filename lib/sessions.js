...
function saveJar(jar) {
  ...
  try {
    ...
    fs.writeFileSync(tmp, JSON.stringify({
      cookiesByOrigin: sanitizeCookieStores(jar.cookiesByOrigin), user: sanitizeUser(jar.user), apiHost: jar.apiHost || '',
      favoriteFolders: jar.favoriteFolders || [], favoriteFolderMap: jar.favoriteFolderMap || {}, hiddenHistory: jar.hiddenHistory || [],
    }), { mode: 0o600 });
...
module.exports = {
  ...
  flushAll, destroyJar, sanitizeUser, clearUpstreamAuth, hasUpstreamAuth, DATA_DIR,
};
